...
const QA = [
  ...
  { q: "Is there a live map and tracking?", a: "A live map with real road routing from pickup to delivery and driver positions, with the load record one tap away." },
  ...
  { q: "How does factoring work?", a: "Send a broker invoice straight to RTS or your factor in one click, and watch receivables age in real time on the dashboard." },
];
