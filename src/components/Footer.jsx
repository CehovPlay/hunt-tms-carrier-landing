  ...
  return (
    <footer className="bg-white pt-[120px]">
      ...
      <Container className="flex flex-col items-start justify-between gap-12 pb-[120px] md:flex-row">
        <div className="flex w-full flex-col items-start gap-10 md:max-w-[890px]">
        ...
        <div className="flex w-full items-start justify-end md:w-[283px]">
      ...
      <div className="border-t border-dashed border-[#c7c7c7]" />

      {/* Giant faint wordmark (brand SVG — matches Figma / prod) */}
      <div className="overflow-hidden py-10">
        <img src="/hunterTMS.svg" alt="hunterTMS" className="pointer-events-none w-full select-none opacity-[0.06]" />
      </div>

      {/* Legal bar */}
      <div className="border-t border-[#e8e8e8]">
        <Container className="flex h-[56px] items-center justify-between py-5 text-xs font-medium tracking-[-0.48px] text-[#a2a2a2]">
